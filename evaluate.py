...
def run_evaluation():
    ...
    data = {
        ...
        "Jawaban_Generated_(Hasil AI)": [    
            "SMK Negeri 1 Sorong menyediakan 9 Program Keahlian untuk calon peserta didik baru, yaitu Akuntansi dan Keuangan Lembaga, Manajemen Perkantoran dan Layanan Bisnis, Pemasaran (Kelas Alfamart), Teknik Jaringan Komputer dan Telekomunikasi, Desain Komunikasi Visual, Pengembangan Perangkat Lunak dan Gim, Teknik Geologi Pertambangan, Teknik Perminyakan, dan Teknik Energi Terbarukan.",
            "Pendaftaran di SMK Negeri 1 Sorong dilakukan secara online dan offline. Calon peserta didik mendaftar terlebih dahulu melalui sistem pendaftaran online (SPMB) pada laman resmi spmbkota.sorongdigital.id, kemudian datang ke sekolah membawa bukti pendaftaran dan dokumen persyaratan untuk proses verifikasi.",
            "Tidak terdapat persyaratan khusus seperti tes fisik atau tes bebas buta warna untuk mendaftar pada program keahlian Teknik Jaringan Komputer dan Telekomunikasi. Tahapan seleksi umum di sekolah hanya terdiri atas tes tertulis dan wawancara serta pemenuhan batas usia maksimal 21 tahun.",
            "Pelaksanaan pendaftaran PPDB di SMK Negeri 1 Sorong Tahun Ajaran 2026/2027 mulai dibuka tanggal 17 Juni 2026 sampai dengan 20 Juni 2026.",
            "SMK Negeri 1 Sorong beralamat di Jl. Basuki Rahmat, Kilometer 8, Kelurahan Malaingkedi, Kecamatan Malaimsimsa, Kota Sorong, Provinsi Papua Barat Daya. Gedung pelayanan panitia pendaftaran berada di sebelah kiri jalur masuk sekolah (bangunan dua lantai berwarna biru).",
            "Pendaftaran PPDB maupun proses daftar ulang di SMK Negeri 1 Sorong tidak dikenakan biaya sama sekali (gratis). Selain itu, pihak sekolah juga tidak memungut biaya uang sekolah atau SPP.",
            "Ya, penerimaan peserta didik baru di SMK Negeri 1 Sorong dapat dilaksanakan melalui Jalur Prestasi, yaitu jalur yang diperuntukkan bagi calon murid yang memiliki prestasi akademik maupun non akademik, dibuktikan dengan sertifikat atau piagam penghargaan asli.",
            "Kegiatan ekstrakurikuler yang dapat diikuti di SMK Negeri 1 Sorong antara lain Pramuka, Palang Merah Remaja (PMR), Mapala (Pecinta Alam), Paskibra, Basket, Futsal, Sepak Bola, Bulu Tangkis, Pencak Silat, serta Marching Band.",
            "Berkas yang harus disiapkan saat daftar ulang meliputi fotokopi SKL, Akte Kelahiran, Kartu Keluarga terbaru, KPS/PKH/KIP (jalur afirmasi), rapor semester 1-5, Sertifikat TKA, piagam prestasi (jalur prestasi), Materai Rp10.000 (1 lembar), serta Map merah untuk OAP atau Map biru untuk non-OAP.",
            "Jumlah kuota penerimaan peserta didik baru SMK Negeri 1 Sorong Tahun Ajaran 2026/2027 adalah sebanyak 684 peserta didik, yang terbagi ke dalam 9 Program Keahlian."
        ]
    }
